...
const SuperviseeAssessmentPage = () => {
  ...
  useEffect(() => {
    const fetchAssessments = async () => {
      try {
        const res = await AssessmentService.getAssessmentByUserId(sId)
        console.log('Supervisee Assessments:', res.data)
  ...
  return (
    <div className='flex flex-col gap-4 p-5'>
      <p className='font-semibold text-2xl'> Assessments</p>
...
export default SuperviseeAssessmentPage
