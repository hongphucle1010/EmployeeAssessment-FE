...
const CardItem = [
    { title: 'Profile', bgColor: 'bg-yellow-50', borderColor: 'border-yellow-300', link: '/profile', content: 'View and edit your personal profile' },
    { title: 'Assessment', bgColor: 'bg-indigo-50', borderColor: 'border-indigo-300', link: '/assessment', content: 'Check out the assessments given by your supervisors' },
    { title: 'Criteria', bgColor: 'bg-purple-50', borderColor: 'border-purple-300', link: '/assessment-criteria', content: 'Manage the criteria used for making assessments' },
    { title: 'Employees', bgColor: 'bg-rose-50', borderColor: 'border-red-300', link: '/employees', content: 'View and manage all of your employees' },
]
